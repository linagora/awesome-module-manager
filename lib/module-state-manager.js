...
AwesomeModuleStateManager.prototype._fireModuleStateCallbacks = function(stateName, module) {
  var store = this.moduleStore,
      ...
      logger = this.logger;
  return function() {
    logger.debug('AwesomeModuleStateManager._fireModuleStateCallbacks(' + module.name + ')');
    ...
    .map(function(dependency) {
      logger.debug('AwesomeModuleStateManager._fireModuleStateCallbacks(' + module.name + '): launching callbacks for ' +

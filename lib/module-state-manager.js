...
AwesomeModuleStateManager.prototype.fire = function(stateName, module) {
  if (!this._moduleStateFiredCache[stateName] || !this._moduleStateFiredCache[stateName][module.name]) {
    this._moduleStateFiredCache[stateName] = this._moduleStateFiredCache[stateName] || {};
    this._moduleStateFiredCache[stateName][module.name] = this._ensureValidState(stateName)
  ...
  return this._moduleStateFiredCache[stateName][module.name];
};
